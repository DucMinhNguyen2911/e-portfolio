        ...
        <section className="contact section" id="contact">
            ...
            <div className="contact__container container_ grid_">
                <div className="contact__card">
                    ...
                    <span className="contact__card-data">minhaprovip6996@gmail.com</span>
                    <a href="mailto:minhaprovip6996@gmail.com" className="contact__button">
                        Write me{" "}
                ...
                <div className="contact__card">
                    ...
                    <span className="contact__card-data">duc.minh.2911</span>
                    <a href="https://m.me/duc.minh.2911" className="contact__button">
                        Write me{" "}
                        <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                    </a>
                </div>
