        ...
        <footer className="footer">
            <div className="footer__container container_">
                ...
                <div className="footer__social">
                    <a href="https://www.instagram.com/ndminh.a" className="footer__social-link" target="_blank">
                        <i class="uil uil-instagram"></i>
                    </a>
                    <a href="https://www.facebook.com/duc.minh.2911" className="footer__social-link" target="_blank">
